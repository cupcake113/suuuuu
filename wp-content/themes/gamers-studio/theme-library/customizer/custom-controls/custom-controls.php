...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Gamers_Studio_Toggle_Switch_Custom_Control extends WP_Customize_Control {
	 ...
	 */
	class Gamers_Studio_Separator_Custom_Control extends WP_Customize_Control {
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Gamers_Studio_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'gamers-studio-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="gamers_studio_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand <?php echo $section_class; ?>">
